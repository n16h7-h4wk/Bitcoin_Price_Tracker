    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                Log.d("Bitcoin", "Selected Item " + adapterView.getItemAtPosition(i));
                String str = BASE_URL+adapterView.getItemAtPosition(i);
                Log.d("Bitcoin","URL is " +str);

                letsDoSomeNetworking(str);
    ...
    private void letsDoSomeNetworking(String url) {
        ...
        client.get(url,new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, cz.msebera.android.httpclient.Header[] headers, JSONObject responseBody) {
                ...
                BitcoinDataModel data = BitcoinDataModel.gfromJson(responseBody);
                mPriceTextView.setText(data.getValue());
            }
